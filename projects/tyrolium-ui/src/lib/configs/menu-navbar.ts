...
export const NavbarMenuCategory: ITyroUiNavbarMenuCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        imageLight: 'assets/tyrolium-ui/projects/Influnias-White.png',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        descriptionEn: 'Your public IP address',
        icon: 'ri-map-pin-user-fill',
        link: 'https://ip.tyrolium.fr',
      },
      {
        name: 'Speedtest',
        description: 'Test de débit sur notre infra',
        descriptionEn: 'Speed test on our infrastructure',
  ...
  },
  {
    ...
    items: [
      ...
      //   name: 'Hub Interne',
      //   nameEn: 'Internal Hub',
      //   description: 'Pilotage central du groupe',
      //   descriptionEn: 'Central group control panel',
      ...
      },
      {
        ...
        descriptionEn: 'Course platform',
        icon: 'ri-graduation-cap-fill',
        link: 'https://formation.tyrolium.fr',
      },
    ],
  },
];
